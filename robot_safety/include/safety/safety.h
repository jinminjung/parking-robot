#ifndef ROBOTSAFETY_H_
#define ROBOTSAFETY_H_
...
#include <robot_safety/RobotSafetyConfig.h>
...
private:
	...
	void reconfig_callback(robot_safety::RobotSafetyConfig &config, uint32_t level);
	dynamic_reconfigure::Server<robot_safety::RobotSafetyConfig> reconfigure_server_;
};
