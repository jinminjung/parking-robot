...
{
  boost::thread spin_thread = boost::thread(boost::bind(&robot::spinThread, this));
}
...
void robot::spinThread()
{
  ros::spin();
}

void robot::move_map(double x, double y, double theta)
{
...
void robot::move_base(double x, double y, double theta)
{
  MoveBaseClient ac("move_base");
